...
export const fr: Translations = {
  ...
  tasks: {
    ...
    detailedDescriptions: {
      ...
      reclassify_all: "Ré-exécute l'analyse IA sur tous les documents dont l'OCR est terminé, qu'ils aient déjà été analysés ou non. Les documents sans OCR sont ignorés et comptabilisés dans le log. À utiliser pour rafraîchir la classification de toute la bibliothèque — par exemple après un changement de taxonomie ou de fournisseur IA.",
